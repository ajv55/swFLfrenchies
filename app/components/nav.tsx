...
export default function Nav(prop: HamburgerProps) {
  ...
  return (
    <div className="flex justify-between w-full absolute overflow-hidden bg-transparent z-10 ">
