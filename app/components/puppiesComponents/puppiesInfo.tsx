...
export default function PuppiesInfo() {
  ...
  return (
    <div  className='relative w-full h-content bg-slate-700 flex flex-col justify-center lg:items-center items-start mt-32 mb-32 overflow-hidden'>
        ...
        <motion.h1 className={`${alex_brush.className} text-center tracking-wide lg:text-8xl lg:w-[70%] text-6xl bg-gradient-to-r to-fuchsia-400 from-red-300 text-transparent bg-clip-text mt-56 mb-48`}>Reserve Your Perfect Frenchie Puppy Today!</motion.h1> 
        <div className='mb-44 w-[60%]'>
