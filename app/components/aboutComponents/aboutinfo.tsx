...
export default function AboutInfo() {
  return (
    <div className='bg-slate-700 w-full flex flex-col justify-start items-center h-content relative gap-9 mt-12'>
        ...
        <h1 className={`${dancing_script.className} px-1 mt-64 mb-16 text-7xl text-center bg-gradient-to-br from-purple-200 to-fuchsia-500 bg-clip-text text-transparent`}>What We Are About!</h1>
        ...
        <div className='w-[21rem] h-content rounded-md px-2 py-3  flex flex-col justify-center items-center gap-7 shadow-lg shadow-fuchsia-100 text-center '>
            <h1 className='text-4xl tracking-light font-light text-white'>Transparency and Trust</h1>
        ...
        <div className='w-[21rem] h-content rounded-md px-2 py-3  flex flex-col justify-center items-center gap-7 shadow-lg shadow-fuchsia-100 text-center '>
            <h1 className='text-4xl tracking-light font-light text-white'>Lifetime Support</h1>
        ...
        <div className='w-[21rem] h-content rounded-md px-2 py-3  flex flex-col justify-center items-center gap-7 shadow-lg shadow-fuchsia-100 text-center '>
            <h1 className='text-4xl tracking-light font-light text-white'>Health Guarantee</h1>
        ...
        <div className='w-[21rem] h-content rounded-md px-2 py-3  flex flex-col justify-center items-center gap-7 shadow-lg shadow-fuchsia-100 text-center mb-64'>
            <h1 className='text-4xl tracking-light font-light text-white'>Community and Education</h1>
