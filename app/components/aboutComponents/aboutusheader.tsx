...
() {
  return (
    <div className='text-center bg-gradient-to-tl from-slate-700 via-slate-600 to-slate-500 relative w-full h-[34rem] flex flex-col justify-center items-center'>
