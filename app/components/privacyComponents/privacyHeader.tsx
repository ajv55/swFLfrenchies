...
export default function PrivacyHeader() {
  return (
    <div className='bg-slate-700 relative w-full h-[34rem] flex justify-center items-center'>
        ...
        <h2 className='text-center lg:text-7xl text-4xl text-white tracking-wider font-semibold'>Privacy Policy</h2>
    </div>
  )
}
