    ...
    <div className=" w-full h-content mt-28 mb-28 flex flex-col  justify-center items-center gap-10">
        ...
        <div className=' w-full flex lg:flex-row lg:flex-wrap h-content flex-col justify-center items-center gap-10 '>
            ...
            <div className={`${roboto.className} bg-gradient-to-tr from-slate-400 via-slate-700 to-slate-900 w-[22rem] lg:w-[32rem] h-[31rem] rounded-lg relative flex justify-center items-center flex-col gap-14 p-2`}>
                ...
                <p className='text-center lg:text-xl lg:px-2 text-sm text-white'><span className='font-bold bg-gradient-to-tr from-red-400 via-orange-200 to-pink-400 bg-clip-text text-transparent'>French Bulldog puppies require regular veterinary care to ensure they stay healthy</span> and happy. Schedule routine check-ups, vaccinations, and preventive treatments as recommended by your veterinarian. Keep an eye out for any signs of health issues, such as breathing difficulties, skin problems, or joint concerns, and address them promptly with professional guidance.</p>
                <Meteors className='lg:hidden'/>
            </div>
            ...
            <div className={`${roboto.className} bg-gradient-to-tr from-slate-400 via-slate-700 to-slate-900 w-[22rem] lg:w-[32rem] h-[31rem] rounded-lg relative flex justify-center items-center flex-col gap-14 p-2`}>
                ...
                <p className='text-center lg:text-xl lg:px-2 text-sm text-white'><span className='font-bold bg-gradient-to-tr from-red-400 via-orange-200 to-pink-400 bg-clip-text text-transparent'>French Bulldogs are a brachycephalic breed, meaning they have flat faces and shortened airways.</span> This anatomical feature can predispose them to respiratory issues, especially in hot or humid weather. Take precautions to keep your Frenchie puppy cool and comfortable, avoid strenuous exercise in extreme temperatures, and provide plenty of fresh water and shade.</p>
                <Meteors className='lg:hidden'/>
            </div>
            ...
            <div className={`${roboto.className} bg-gradient-to-tr from-slate-900 via-slate-700 to-slate-400 w-[22rem] lg:w-[42rem]  h-[31rem] rounded-lg relative flex justify-center items-center flex-col gap-14 p-2`}>
                ...
                <p className='text-center lg:text-xl lg:px-2 text-sm text-white'>Provide your Frenchie puppy with a balanced and nutritious diet formulated specifically for their age, size, and activity level. <span className='font-bold bg-gradient-to-tr from-red-400 via-orange-200 to-pink-400 bg-clip-text text-transparent'>Choose high-quality dog food that meets their nutritional requirements and avoid overfeeding to prevent obesity, which can exacerbate health issues.</span> Consult with your veterinarian for personalized feeding recommendations.</p>
                <Meteors className='lg:hidden' />
            </div>
        </div>
    </div>
