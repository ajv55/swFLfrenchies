  ...
  return (
    <div>
        ...
        backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url("https://img1.wsimg.com/isteam/ip/a6b0b43f-f385-4405-82bc-646f3a983b54/Puppies%E2%AD%90.jpg")'
         ...
         <h1 className={`${alex_brush.className} text-center text-6xl bg-gradient-to-r to-fuchsia-400 from-red-300 text-transparent bg-clip-text `}>Welcome to Our Frenchie Puppy Showcase</h1>
      </div>
      <PuppiesList />
      <PuppiesInfo />
    </div>
